...
def mult(x: Z, y: Z): Z = {
  //what goes here?          Contract(
  //what should we require?    Requires(y >= 0),
  //what should we ensure?    Ensures(Res[Z] == y)
...
//answer == x * y to satisfy postcondition
  } else {
...
Deduce(
  ...
  //what do we need to do here?:   //answer == x * y to satisfy postcondition
